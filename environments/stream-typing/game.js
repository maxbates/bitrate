...
function renderResults(opts) {
  ...
  $('res-tiles').innerHTML = m ? tilesHTML(m) : '';
  $('chart-pace').innerHTML = m && m.selections > 1 ? paceChartSVG(m) : '';
  $('chart-iki').innerHTML = m && m.selections > 1 ? ikiChartSVG(m) : '';
}
